document.addEventListener("DOMContentLoaded", async () => {
    ...
    if (currentPage === "login") {
      ...
      try {
        const response = await fetch("http://localhost:3000/api/v1/cinemas", {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
            "x-electron-request": "true",
      ...
      async function fetchRoomsData(cinemaId) {
        try {
          const response = await fetch(
            `http://localhost:3000/api/v1/getRoomsByCinema/${cinemaId}`,
            {
              method: "GET",
              headers: {
                "Content-Type": "application/json",
      ...
      async function fetchSeatsData(roomId) {
        try {
          const response = await fetch(
            `http://localhost:3000/api/v1/seatsByRooms/${roomId}`,
            {
              method: "GET",
              headers: {
                "Content-type": "Application/json",
      ...
      async function postIntervention() {
        try {
          ...
          const response = await fetch("http://localhost:3000/api/v1/incident", {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
              "x-electron-request": "true",
        ...
        try {
          ...
          if (response.ok && incidents.length > 0) {
            ...
            incidents.forEach((incident) => {
              ...
              incidentImage.src = `http://localhost:3000/uploads/${incident.cinema_image}`;
