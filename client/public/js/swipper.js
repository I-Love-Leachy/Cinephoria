const initSwipper = () => {
  ...
  const chooseDaysSlider = new Swiper(".choose-days-slider", {
    slidesPerView: "auto", // Permet à chaque slide de prendre toute la largeur disponible
    spaceBetween: 10, // Garde un espace entre les slides pour éviter les overlaps
    grabCursor: true,
    pagination: {
      el: ".swiper-pagination",
      clickable: true,
    ...
    breakpoints: {
      ...
      1024: {
        slidesPerView: "auto", // Laisse les slides s'adapter à la largeur
        spaceBetween: 10,
      },
      1280: {
        slidesPerView: "auto",
