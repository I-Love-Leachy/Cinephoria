...
const { getRooms } = require("../../../controllers/rooms/rooms.controller");
...
adminDashboardRoutes.get(
  ...
  async (req, res) => {
    try {
      ...
      console.error(
        "Error fetching reservations from MongoDB or movies from PostgreSQL:",
        err
      );
...
adminDashboardRoutes.get(
  ...
  enrichUserWithInfo,
  (req, res) => {
    res.render("layouts/dashboard/admin/films", {
...
adminDashboardRoutes.get(
  ...
  enrichUserWithInfo,
  (req, res) => {
    res.render("layouts/dashboard/admin/addMovie", {
...
adminDashboardRoutes.get(
  ...
  enrichUserWithInfo,
  (req, res) => {
    res.render("layouts/dashboard/admin/selectUpdateMovie", {
...
adminDashboardRoutes.get(
  ...
  async (req, res) => {
    ...
    console.log(movie);
    res.render("layouts/dashboard/admin/updateMovie", {
...
adminDashboardRoutes.get(
  ...
  enrichUserWithInfo,
  (req, res) => {
    res.render("layouts/dashboard/admin/deleteMovieSelection", {
      title: `Choisir le film a Supprimer.`,
    });
  }
);
...
adminDashboardRoutes.get(
  ...
  enrichUserWithInfo,
  (req, res) => {
    res.render("layouts/dashboard/admin/rooms", {
...
adminDashboardRoutes.get(
  ...
  async (req, res) => {
    try {
      ...
      res.render("layouts/dashboard/admin/addRooms", {
...
adminDashboardRoutes.get(
  ...
  async (req, res) => {
    ...
    res.render("layouts/dashboard/admin/updateRooms", {
...
adminDashboardRoutes.get(
  ...
  async (req, res) => {
    ...
    const rooms = await getRooms(req, res);
    try {
      res.render("layouts/dashboard/admin/deleteRooms", {
...
adminDashboardRoutes.get(
  ...
  enrichUserWithInfo,
  (req, res) => {
    res.render("layouts/dashboard/admin/employees", {
      title: `Modifier ou ajouter des films à l'affiche.`,
    });
  }
);
...
adminDashboardRoutes.get(
  ...
  enrichUserWithInfo,
  (req, res) => {
    res.render("layouts/dashboard/admin/addEmployees", {
...
adminDashboardRoutes.get(
  ...
  async (req, res) => {
    ...
    res.render("layouts/dashboard/admin/selectUpdateEmployees", {
...
adminDashboardRoutes.get(
  ...
  async (req, res) => {
    ...
    res.render("layouts/dashboard/admin/updateEmployees", {
      title: `Modifier le compte de votre employé.`,
      users: users,
    });
  }
...
adminDashboardRoutes.get(
  ...
  async (req, res) => {
    try {
      ...
      res.render("layouts/dashboard/admin/selectDelete", {
...
adminDashboardRoutes.get(
  ...
  enrichUserWithInfo,
  (req, res) => {
    res.render("layouts/dashboard/admin/showtimes", {
...
adminDashboardRoutes.get(
  ...
  async (req, res) => {
    try {
      const cinemas = await getCinemas(req, res);
      const rooms = await getRooms(req, res);
      res.render("layouts/dashboard/admin/selectMovie", {
      ...
      console.log(err);
      res.render("layouts/dashboard/admin/selectMovie", {
        title: `Choisir quel film projeter.`,
        cinemas: cinemas || [],
        rooms: rooms || [],
      });
    }
...
adminDashboardRoutes.get(
  ...
  enrichUserWithInfo,
  (req, res) => {
    res.render("layouts/dashboard/admin/addShowtimes", {
...
adminDashboardRoutes.get(
  ...
  async (req, res) => {
    try {
      const cinemas = await getCinemas(req, res);
      const rooms = await getRooms(req, res);
      res.render("layouts/dashboard/admin/updateShowtimes", {
...
adminDashboardRoutes.get(
  ...
  async (req, res) => {
    try {
      const cinemas = await getCinemas(req, res);
      const rooms = await getRooms(req, res);
      res.render("layouts/dashboard/admin/deleteShowtimes", {
...
adminDashboardRoutes.get(
  ...
  async (req, res) => {
    ...
    const users = await getUsers(req, res);
    const employees = users.filter((user) => user.role === "employee");
    res.render("layouts/dashboard/admin/assign", {
