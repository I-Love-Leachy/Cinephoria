...
async function getShowtimesByCinema(req, res) {
  try {
    ...
    const query = `
      SELECT DISTINCT ON (m.movie_id) m.movie_id, m.title, m.poster, m.description, m.genre, m.release_date,
